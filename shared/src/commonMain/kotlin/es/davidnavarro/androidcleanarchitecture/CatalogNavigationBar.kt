...
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.Res
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.character_navigation_reference
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.episode_navigation_reference
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.location_navigation_reference
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.navigation_characters
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.navigation_episodes
import es.davidnavarro.androidcleanarchitecture.shared.generated.resources.navigation_locations
...
private fun TechCatalogNavigation(
    ...
    val navigationArtwork = when (selectedDestination) {
        CatalogDestination.Characters -> Res.drawable.character_navigation_reference
        CatalogDestination.Locations -> Res.drawable.location_navigation_reference
        CatalogDestination.Episodes -> Res.drawable.episode_navigation_reference
    }
    Box(modifier) {
        Image(
...
internal enum class CatalogDestination(val route: String, val label: StringResource, val icon: ImageVector) {
    Characters("characters", Res.string.navigation_characters, Icons.Default.Person),
    Locations("locations", Res.string.navigation_locations, Icons.Default.Place),
    Episodes("episodes", Res.string.navigation_episodes, Icons.Default.PlayArrow)
}

internal const val CHARACTERS_LIST_ROUTE = "characters/list"
internal const val CHARACTER_DETAIL_ROUTE = "characters/detail"
internal const val LOCATIONS_LIST_ROUTE = "locations/list"
internal const val LOCATION_DETAIL_ROUTE = "locations/detail"
internal const val EPISODES_LIST_ROUTE = "episodes/list"
internal const val EPISODE_DETAIL_ROUTE = "episodes/detail"
