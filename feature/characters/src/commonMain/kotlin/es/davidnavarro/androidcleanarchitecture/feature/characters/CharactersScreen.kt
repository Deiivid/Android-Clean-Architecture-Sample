...
import es.davidnavarro.androidcleanarchitecture.feature.characters.generated.resources.characters_empty
import es.davidnavarro.androidcleanarchitecture.feature.characters.generated.resources.characters_loaded
...
import es.davidnavarro.androidcleanarchitecture.feature.characters.generated.resources.characters_subtitle
import es.davidnavarro.androidcleanarchitecture.feature.characters.generated.resources.characters_title
        ...
        Scaffold(containerColor = Color.Transparent) { padding ->
            when (uiState) {
                CharactersUiState.Loading -> LoadingContent(
                    padding = padding,
                    label = stringResource(Res.string.characters_loading)
                )
                CharactersUiState.Empty -> MessageContent(
                    padding = padding,
                    message = stringResource(Res.string.characters_empty)
                )
                is CharactersUiState.Error -> ErrorContent(
                    padding = padding,
                    message = characterErrorMessage(uiState.error),
                    retryLabel = stringResource(Res.string.characters_retry),
                    onRetry = onRetry
                )
...
private fun CharacterList(
    ...
    LazyColumn(
        ...
        item(key = "header") {
            CatalogHeader(
                title = stringResource(Res.string.characters_title),
                subtitle = stringResource(Res.string.characters_subtitle),
                count = pluralStringResource(
                    Res.plurals.characters_loaded,
