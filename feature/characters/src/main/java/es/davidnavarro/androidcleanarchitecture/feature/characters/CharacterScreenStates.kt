    ...
    Column(
        ...
        when {
            state.isLoadingMore -> LoadingIndicator(
                label = stringResource(R.string.characters_loading_more)
            )
...
internal fun characterErrorMessage(error: CatalogError): String = when (error) {
    CatalogError.Connectivity -> stringResource(R.string.characters_error_connectivity)
    is CatalogError.Http -> stringResource(R.string.characters_error_service)
    CatalogError.Serialization -> stringResource(R.string.characters_error_format)
    CatalogError.Unexpected -> stringResource(R.string.characters_error)
}
