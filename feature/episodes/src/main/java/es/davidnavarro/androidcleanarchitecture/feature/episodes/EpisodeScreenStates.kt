    ...
    Column(
        ...
        when {
            state.isLoadingMore -> LoadingIndicator(
                label = stringResource(R.string.episodes_loading_more)
            )
...
internal fun episodeErrorMessage(error: CatalogError): String = when (error) {
    CatalogError.Connectivity -> stringResource(R.string.episodes_error_connectivity)
    is CatalogError.Http -> stringResource(R.string.episodes_error_service)
    CatalogError.Serialization -> stringResource(R.string.episodes_error_format)
    CatalogError.Unexpected -> stringResource(R.string.episodes_error)
}
