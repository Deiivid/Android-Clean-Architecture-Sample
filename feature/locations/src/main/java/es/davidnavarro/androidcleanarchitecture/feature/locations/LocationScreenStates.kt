    ...
    Column(
        ...
        when {
            state.isLoadingMore -> LoadingIndicator(
                label = stringResource(R.string.locations_loading_more)
            )
...
internal fun locationErrorMessage(error: CatalogError): String = when (error) {
    CatalogError.Connectivity -> stringResource(R.string.locations_error_connectivity)
    is CatalogError.Http -> stringResource(R.string.locations_error_service)
    CatalogError.Serialization -> stringResource(R.string.locations_error_format)
    CatalogError.Unexpected -> stringResource(R.string.locations_error)
}
