        ...
        Surface(
            ...
            IconButton(onClick = onBack) {
                Icon(
                    ...
                    stringResource(R.string.location_back),
                    tint = PortalGreen
                )
            }
        }
...
private fun LocationMetadataGrid(location: Location) {
    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(CatalogDimens.dp6)) {
        DetailTile(
            ...
            stringResource(R.string.location_type_label),
    ...
    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(CatalogDimens.dp6)) {
        DetailTile(
            ...
            pluralStringResource(R.plurals.location_residents, location.residentCount, location.residentCount),
            Modifier.weight(1f)
        )
        DetailTile(
            Icons.Outlined.Info,
            stringResource(R.string.location_identifier_label),
            stringResource(R.string.location_identifier_value, location.id),
            Modifier.weight(1f)
        )
    }
}
...
private fun InformationHeader() {
    Row(
        ...
        Text(
            stringResource(R.string.location_detail_information),
            color = SpaceText,
