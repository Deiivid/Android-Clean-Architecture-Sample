...
fun LocationsScreen(
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Scaffold(containerColor = Color.Transparent) { padding ->
            when (uiState) {
                LocationsUiState.Loading -> LoadingContent(padding, stringResource(R.string.locations_loading))
                LocationsUiState.Empty -> MessageContent(padding, stringResource(R.string.locations_empty))
    ...
    LazyColumn(
        ...
        item(key = "header") {
            CatalogHeader(
                ...
                subtitle = stringResource(R.string.locations_subtitle),
...
private fun CatalogHeader(title: String, subtitle: String, count: String) {
    BoxWithConstraints(Modifier.fillMaxWidth()) {
        ...
        Box(
            ...
            Image(
                painter = painterResource(R.drawable.location_header_platform),
            ...
            Image(
                painter = painterResource(R.drawable.location_header_pin),
                contentDescription = null,
                modifier = Modifier
                    .size(headerHeight * .92f)
                    .align(Alignment.CenterEnd)
            ...
            Box(Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    MetadataRow(
                        ...
                        stringResource(R.string.location_dimension_label),
                        localizedDimensionValue(location.dimension),
                        compact
                    )
                    MetadataRow(
                        Icons.Outlined.Groups,
                        stringResource(R.string.location_residents_label),
